...
public class RadnaStolicaFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RadnaStolicaFrame frame = new RadnaStolicaFrame();
	 ...
	 * Create the frame.
	 */
	public RadnaStolicaFrame() {
		setTitle("Frame Radna Stolica 1");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (Mwain.isNumber(id)== true) {
					...
					RadnaStolica provera = firma.stolicaBrisanjeID(idX);
					if (provera == null) {
