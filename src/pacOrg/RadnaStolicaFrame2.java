...
public class RadnaStolicaFrame2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RadnaStolicaFrame2 frame = new RadnaStolicaFrame2();
	 ...
	 * Create the frame.
	 */
	public RadnaStolicaFrame2() {
		setTitle("Frame Radna Stolica 2");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				firma.loadStolica("radnaStolica2.txt");
				...
				if (Mwain.isNumber(id)== true) {
					...
					boolean provera = firma.dodavanjeStolice2(radnaStolica);
					if (provera) {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (Mwain.isNumber(id)== true) {
					...
					RadnaStolica provera = firma.stolicaBrisanjeID2(idX);
					if (provera == null) {
